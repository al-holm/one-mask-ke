...
class PersonalityDataset(Dataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for case_idx, sample in enumerate(raw):
            ...
            )  # fix the target personality while test
    ...
    def _collate_fn(self, batch):
        ...
        inner_qa = [
            "Question: " + q + "\n </s> Answer: " + a
            for q, a in zip(inner_prompt, inner_comp)
        ]
        all_qa = [
            "Question: " + q + " \n </s> Answer: " + a
    ...
    def collate_gpt_fn(self, batch):
        ...
        same_mask = torch.tensor(
            [i == o for i, o in zip(edit_toks["target_per"], edit_toks["all_per"])],

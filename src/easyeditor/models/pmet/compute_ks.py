...
from .compute_zs import (
    get_modules_input_output_at_words,
...
def compute_ks_parallel(
    ...
    layers_ks[rewrite_module_tmps[0]], layers_ks[rewrite_module_tmps[1]] = (
        get_modules_input_output_at_words(
            model,
            tok,
            layer,
    ...
    for rewrite_module_tmp in rewrite_module_tmps:
        context_type_lens = [0] + [
            len(context_type) for context_type in context_templates
        ]
